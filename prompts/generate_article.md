...
不協（ディゾナンス）の話を始める前に、必ず以下の固定文を置くこと。
...
## 7 不協（ディゾナンス）はどう悪循環を作るのか

この見出しの直前に、必ず固定文を置くこと。
