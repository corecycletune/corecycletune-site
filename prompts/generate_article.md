...
- 東洋医学パートを入れる場合は、用語を少し引用しつつ、症状とのつながりまで説明してください
- 「もちろん主軸は現代の〜研究ですが」のような逃げの定型文は使わないでください
...
東洋医学の視点を入れる場合は、以下を守ってください。

- 一言だけ添えるのではなく、**最低でも2〜3文で厚みを持たせる**
- 用語を少し引用してください
- 用語を置くだけで終わらず、その症状とどうつながるか説明してください
- 次のような逃げの書き方は禁止です  
  - もちろん主軸は現代の〜研究ですが  
  - もちろん説明の中心は〜ですが  
  - 西洋医学が主軸ですが
...
- 食後の重さや眠気なら、脾や痰湿の話へつなぐ
- ざわつきや焦りなら、肝鬱、心神不寧、陰虚火旺などの概念と接続する
- 鼻づまりや重だるさなら、痰湿や水の停滞と結びつける

重要

- 現代研究との並列紹介ではなく、**症状理解を一段深める補助線** として使ってください
- 無理に入れないでください
- 入れるなら薄くしないでください
